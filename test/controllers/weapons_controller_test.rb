...
class WeaponsControllerTest < ActionController::TestCase
  ...
  test "should create weapon" do
    assert_difference('Weapon.count') do
      post :create, weapon: { factory: @weapon.factory, model: @weapon.model, serialNumber: @weapon.serialNumber }
    end
  ...
  test "should update weapon" do
    patch :update, id: @weapon, weapon: { factory: @weapon.factory, model: @weapon.model, serialNumber: @weapon.serialNumber }
    assert_redirected_to weapon_path(assigns(:weapon))
  end
